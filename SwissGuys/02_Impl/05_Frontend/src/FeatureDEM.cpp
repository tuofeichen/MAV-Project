 ...
 * @brief This file contains the implementation of the FeatureDEM class.
 *
 */

#include "FeatureDEM.h"

cv::Ptr<cv::ORB> FeatureDEM::detecterExtracter = cv::ORB::create(nrOfKeyPoints, 1.2f, 8, 31, 0, 2, cv::ORB::HARRIS_SCORE, 31, 20);
