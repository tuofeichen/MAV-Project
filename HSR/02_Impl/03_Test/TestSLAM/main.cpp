...
int main()
{
	//
	// downloaded datasets
	// note: to run the the datasets successfully check that the Frame class of the SLAM library uses the korrect intinsic paramters (f_x, f_y, c_x, c_y) and depth scale factor
	//
	RGDBSimulator rgbdSensor("/home/user/git/MasterThesisWork/02_Impl/02_Libs/HAL/simData/rgbd_dataset_freiburg1_desk/");
