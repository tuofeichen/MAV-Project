...
public:
	...
	//static void preprocessing(Frame& frame, int pc_selection);
	void run(pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr pc1,pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr pc2);
