...
DynamicObj::DynamicObj() : currCandidates(cv::Mat(240, 320,CV_8UC1, cvScalar(0))), prevCandidates(cv::Mat(240,320,CV_8UC1, cvScalar(0)))
    {}
							...
							) 
{
    ...
    cv::imshow( "currCandidates", currCandidates );
    cv::waitKey(1);
}
