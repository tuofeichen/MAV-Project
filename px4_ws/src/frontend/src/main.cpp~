...
{	
		...
		sprintf(imgName, "/home/odroid/MAV-Project/px4_ws/src/frontend/Frames/rgb_%d.png",id);
		cv::imwrite(imgName,frame.getGray(),params);
		sprintf(imgName, "/home/odroid/MAV-Project/px4_ws/src/frontend/Frames/dep_%d.png",id);
...
bool readImage(Frame& frame, int id) // implemented for playback debug
{
	...
	ifstream mylog("/home/odroid/MAV-Project/px4_ws/src/frontend/position.csv");
...
int main(int argc, char **argv)
{
	...
	logKpts3D.open("/home/odroid/MAV-Project/px4_ws/src/frontend/matlab_util/keypoints3D.csv", std::ofstream::out | std::ofstream::trunc);
	logKpts.open("/home/odroid/MAV-Project/px4_ws/src/frontend/matlab_util/keypoints.csv", std::ofstream::out | std::ofstream::trunc);


	// start viewer and logger
#ifdef DEBUG
	logPos.open("/home/odroid/MAV-Project/px4_ws/src/frontend/position_debug.csv", std::ofstream::out | std::ofstream::trunc);
	logPos << "time,x,y,z,roll,pitch,yaw,framenum,valid" <<endl;

#else

	logPos.open("/home/odroid/MAV-Project/px4_ws/src/frontend/VSLAM.csv", std::ofstream::out | std::ofstream::trunc);
	logPos << "time,x,y,z,roll,pitch,yaw,framenum,valid" <<endl;

	logLPE.open("/home/odroid/MAV-Project/px4_ws/src/frontend/LPE.csv", std::ofstream::out | std::ofstream::trunc);
